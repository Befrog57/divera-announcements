...
KEYWORDS=("probealarm" "alarm" "einsatz" "gasaustritt" "gasgeruch" "arbeit" "fbma" "fpkwy" "fkleingeb" "fpkw" "flkw" "fklein" "fgebäudey" "fgebäude" "ptür" "rücken" "hlf" "dlk" "lf10" "kats" "rw" "vupkw" "vulkw" "vu-ecall" "vu" "pkw")
